...
import UserTable from "../_components/employees/employeesTable";
import { AddUser } from "../_components/employees/addEm";
...
export default async function ProfilePage() {
  ...
  if (!session || !session.user) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 p-6 text-center">
        <h1 className="text-4xl font-bold mb-4 text-gray-800 dark:text-gray-100">Сотрудники</h1>
  ...
  <>
    ...
    <div className="max-w-4xl mx-auto px-6 py-12 bg-white dark:bg-gray-800 rounded-lg shadow-lg transition-shadow hover:shadow-xl">
      <h1 className="text-3xl md:text-4xl font-bold mb-8 text-center text-gray-800 dark:text-gray-100">Сотрудники</h1>
